...
const candidates: ChartCandidates = {
  ...
  levels: [
    { kind: "support", price: 63900, label: "S", touches: 2, distancePct: 0, pivotTimes: [] },
    { kind: "support", price: 63000, label: "S", touches: 1, distancePct: 0, pivotTimes: [] },
    { kind: "support", price: 61000, label: "S", touches: 3, distancePct: 0, pivotTimes: [] },
    { kind: "support", price: 59000, label: "S", touches: 1, distancePct: 0, pivotTimes: [] },
    { kind: "resistance", price: 64500, label: "R", touches: 2, distancePct: 0, pivotTimes: [] },
    { kind: "resistance", price: 65000, label: "R", touches: 1, distancePct: 0, pivotTimes: [] },
    { kind: "resistance", price: 66000, label: "R", touches: 4, distancePct: 0, pivotTimes: [] },
    { kind: "resistance", price: 68000, label: "R", touches: 1, distancePct: 0, pivotTimes: [] },
    { kind: "fib", price: 63500, label: "Fib 38.2%", touches: 0, distancePct: 0, pivotTimes: [] },
    { kind: "fib", price: 62800, label: "Fib 50.0%", touches: 0, distancePct: 0, pivotTimes: [] },
  ],
};
